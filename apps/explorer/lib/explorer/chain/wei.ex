defmodule Explorer.Chain.Wei do
  @moduledoc """
  The smallest fractional unit of ATH. Using wei instead of ether allows code to do integer match instead of using
  floats.
  ...
  @typedoc """
  ATH is the default unit Ethereum and its side chains are measured in when displaying values to humans.
  ...
  @typedoc """
  The smallest fractional unit of ATH.
  """
  @type wei :: Decimal.t()
